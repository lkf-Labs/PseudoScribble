...
class MultiPointSampler(BasePointSampler):
    ...
    def sample_object(self, sample: DSample):
        ...
        # obtain the background (negative) mask
        neg_mask_bg = np.logical_not(binary_gt_mask)
        # obtain the mask of the object's boundary region
    ...
    # Obtain the sampling mask
    def _sample_mask(self, sample: DSample):
        root_obj_ids = sample.root_objects #255
    ...
    def sample_points(self):
        ...
        # **"Target masks corresponding to three different sampling strategies."**
    ...
    def _get_border_mask(self, mask):
        ...
        # obtain the boundary region mask
