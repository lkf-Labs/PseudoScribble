...
from .modeling.multitask_u2net_p import PseudoScribbleU2NETP


class U2netPseudoScribbleModel(ISModel):
    @serialize
    def __init__(self, backbone_lr_mult=0.1,
                 norm_layer=nn.BatchNorm2d, **kwargs):
        super().__init__(norm_layer=norm_layer, **kwargs)

        self.feature_extractor = PseudoScribbleU2NETP(3, 1) # feature extractor -- u2net lightweight version
